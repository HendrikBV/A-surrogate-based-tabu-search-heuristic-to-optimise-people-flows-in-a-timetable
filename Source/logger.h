...
/*!
 *  @namespace global
 *  @brief	The namespace containing all global elements.
 */
namespace global
{
    ...
    public:
        ...
        /*!
         *	@brief		Writes a QString to the logger based on current status.
         *
         *	@param		l		A reference to a logger.
         *	@param		msg			The string to write.
         *	@returns	A reference to the logger streamed to.
         */
        friend logger & operator<<( logger & l, const QString & msg );
    ...
    protected:
         ...
         *	@param		input		The input text to write to the log.
         */
        void process_text( QString & input );

...
namespace timetable
{
     ...
     */
    class instance_generator: public QObject
    {
        Q_OBJECT
    ...
    public:
         ...
         */
        void generate_instance(const QString &name, int size, int locations);
         ...
         */
        void generate_instance_custom(const QString& name,
                                      int timeslots,
    ...
    signals:
        /*!
         *	@brief      Pass a QString that signals the status.
         */
